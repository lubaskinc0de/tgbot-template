...
async def delete_shop(call: types.CallbackQuery, widget: Any, manager: DialogManager, shop_id: str):
    '''Delete shop'''

    try:
        await delete_shop_service(manager.middleware_data.get('db_session'), int(shop_id))
