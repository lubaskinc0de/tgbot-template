...
from db.services.service_categories import delete_service_category as delete_service_category_service

from sqlalchemy.exc import DBAPIError

async def delete_service_category(call: types.CallbackQuery, widget: Any, manager: DialogManager, service_category_id: str):
    '''Delete service category'''

    try:
        await delete_service_category_service(manager.middleware_data.get('db_session'), int(service_category_id))
