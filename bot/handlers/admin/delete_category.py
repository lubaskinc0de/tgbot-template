...
async def delete_category(call: types.CallbackQuery, widget: Any, manager: DialogManager, category_id: str):
    '''Delete category'''

    try:
        await delete_category_service(manager.middleware_data.get('db_session'), int(category_id))
