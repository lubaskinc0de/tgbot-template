...
async def get_order_data(db_session: Session, dialog_manager: DialogManager, bot: Bot, **kwargs):
...
order_details_window = Window(
    ...
    Format('Описание услуги:\n{order_service_description}', when='order_service_description'),
